...
<body class="dsk-container-4x25 m-0">
    <header>
        ...
        <div class=" dsk-container-4x17 sm-container-4x23 d-flex sombrinha">
            <div class=" row m-0 p-0 justify-content-center">
                <div class=" dsk-container-4x9 sm-container-4x23 borda-right text-center justify-content-center py-5">
                    ...
                    <input class="dsk-container-4x7 sm-container-4x21 m-0 py-2 mb-4" placeholder="Email CPF ou CNPJ" type="text">

                    <input class="dsk-container-4x7 sm-container-4x21 m-0 py-2 mb-4" placeholder="Senha" type="text">
                ...
                <div class="dsk-container-4x8 sm-container-4x23 py-5 ">
                    <div class="h-100 d-flex  align-items-center justify-content-center">
                        ...
                        <button class="text-uppercase dsk-container-4x6 m-0 sm-container-4x21 btn btn-primary">Pirmeiro Acesso?
