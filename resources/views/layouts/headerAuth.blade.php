<header>
    <div class="header-principal bg-light d-flex align-items-center">
        ...
        <div class="dsk-container-4x4 sm-container-4x9">
            <img onclick="window.location.href = '/'" src="{{ asset( 'images/logo5.png' )}}" alt="Logo">
        </div>
    </div>
    <div class="header-secondary bg-light d-flex align-items-center">
        ...
        <div class=" dsk-container-4x4 sm-container-4x19">
            <p class="m-0 font-weight-bold h6">@php echo $titulo @endphp</p>
            <p class="m-0 text-sm">Home > @php echo $pagina @endphp</p>
        </div>
    </div>
</header>
